...
@click.option('-cc', '--capsule_choice', default=['none'], multiple=True, help='Specify multiple sets of capsules to include. Cannot specify both custom_bed and custom_set.', show_default=True, type=click.Choice(["GSEA",'all_gene_sets','genomic_binned','custom_bed','custom_set','gene', 'gene_context', 'GSEA_C5.BP', 'GSEA_C6', 'GSEA_C1', 'GSEA_H', 'GSEA_C3.MIR', 'GSEA_C2.CGP', 'GSEA_C4.CM', 'GSEA_C5.CC', 'GSEA_C3.TFT', 'GSEA_C5.MF', 'GSEA_C7', 'GSEA_C2.CP', 'GSEA_C4.CGN', 'UCSC_RefGene_Name', 'UCSC_RefGene_Accession', 'UCSC_RefGene_Group', 'UCSC_CpG_Islands_Name', 'Relation_to_UCSC_CpG_Island', 'Phantom', 'DMR', 'Enhancer', 'HMM_Island', 'Regulatory_Feature_Name', 'Regulatory_Feature_Group', 'DHS', 'none']))# ADD LOLA!!!
